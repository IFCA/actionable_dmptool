Dmptool2::Application.routes.draw do
  ...
  get 'taxonomies/dmp_for_taxonomy', to: 'taxonomies#dmp_for_taxonomy', as: 'dmp_for_taxonomy'
  post 'upload_tax', to: 'taxonomies#upload'
  ...
  match 'user_sessions/login_fake', to: 'user_sessions#login_fake', as: 'login_fake', :via => [:get, :post]
  ...
  get 'plans/submit_portal/:id', to: 'plans#public' 
  ...
  delete 'delete_taxonomy', to: 'taxonomies#destroy'
