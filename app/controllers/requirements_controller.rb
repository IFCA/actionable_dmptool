class RequirementsController < ApplicationController
  ...
  private
    ...
    def requirement_params
      params.require(:requirement).permit(:position, :text_brief, :text_full, :requirement_type, :taxonomy_id, :obligation, :default, :requirements_template_id, :parent_id, :group, enumerations_attributes: [:id, :requirement_id, :value, :default, :position, :_destroy], labels_attributes: [:id, :requirement_id, :desc, :position, :_destroy])
    end
