...
ActiveRecord::Schema.define(version: 20151106132156) do
  ...
  create_table "requirements", force: true do |t|
    ...
    t.string   "text_brief"
    t.text     "text_full"
    t.enum     "requirement_type",         limit: [:text, :numeric, :date, :enum, :taxonomy]
  ...
  create_table "viaconcepts", force: true do |t|
    t.string   "identifier"
    t.string   "label"
    t.text     "description"
    t.string   "parent"
